...
public class CouponIssueRequestAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
     ...
     */
    public CouponIssueRequestAvroModel(Long issueId, CharSequence callerId, Long couponId, Long amount, java.time.Instant createdAt) {
     ...
     * @param value the value to set.
     */
    public void setCallerId(CharSequence value) {
        this.callerId = value;
    }
     ...
     * @return A new CouponIssueRequestAvroModel RecordBuilder
     */
    public static Builder newBuilder(CouponIssueRequestAvroModel other) {
        if (other == null) {
            return new Builder();
        } else {
            return new Builder(other);
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CouponIssueRequestAvroModel>
         ...
         * @param other The existing instance to copy.
         */
        private Builder(CouponIssueRequestAvroModel other) {
            super(SCHEMA$);
            if (isValidValue(fields()[0], other.issueId)) {
                this.issueId = data().deepCopy(fields()[0].schema(), other.issueId);
         ...
         * @return This builder.
         */
        public Builder setCallerId(CharSequence value) {
        ...
        public CouponIssueRequestAvroModel build() {
            try {
                ...
                record.issueId = fieldSetFlags()[0] ? this.issueId : (Long) defaultValue(fields()[0]);
                record.callerId = fieldSetFlags()[1] ? this.callerId : (CharSequence) defaultValue(fields()[1]);
                record.couponId = fieldSetFlags()[2] ? this.couponId : (Long) defaultValue(fields()[2]);
                record.amount = fieldSetFlags()[3] ? this.amount : (Long) defaultValue(fields()[3]);
