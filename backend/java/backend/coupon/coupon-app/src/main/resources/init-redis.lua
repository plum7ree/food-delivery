...
-- count 다 찼을때 테스트
redis.call("HMSET", "coupon:3000000:issue:info", "startDate", "2000-01-01T00:00:00", "endDate", "2999-01-01T00:00:00", "maxCount", "500")
-- 기간 범위 밖일때 테스트
redis.call("HMSET", "coupon:4000000:issue:info", "startDate", "2999-01-01T00:00:00", "endDate", "2999-01-01T00:00:00", "maxCount", "500")
...
redis.call("SET", "coupon:4000000:issue:count", "0")
