...
public class DriverMatchingEventAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    ...
    private static final BinaryMessageEncoder<DriverMatchingEventAvroModel> ENCODER =
        new BinaryMessageEncoder<>(MODEL$, SCHEMA$);

    private static final BinaryMessageDecoder<DriverMatchingEventAvroModel> DECODER =
     ...
     */
    public static BinaryMessageEncoder<DriverMatchingEventAvroModel> getEncoder() {
        return ENCODER;
    }
     ...
     */
    public static BinaryMessageDecoder<DriverMatchingEventAvroModel> getDecoder() {
        return DECODER;
    }
     ...
     */
    public static BinaryMessageDecoder<DriverMatchingEventAvroModel> createDecoder(SchemaStore resolver) {
        return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
    }

    /**
     * Serializes this DriverMatchingEventAvroModel to a ByteBuffer.
    ...
    /**
     * Deserializes a DriverMatchingEventAvroModel from a ByteBuffer.
     * @param b a byte buffer holding serialized data for an instance of this class
     * @return a DriverMatchingEventAvroModel instance decoded from the given buffer
     * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
     */
    public static DriverMatchingEventAvroModel fromByteBuffer(
     ...
     */
    public DriverMatchingEventAvroModel() {
    }
     ...
     */
    public DriverMatchingEventAvroModel(java.util.UUID userId, com.example.kafka.avro.model.NotificationType notificationType, java.lang.CharSequence message, com.example.kafka.avro.model.OrderDetails orderDetails, com.example.kafka.avro.model.DriverDetails driverDetails) {
        this.userId = userId;
    ...
    /**
     * Creates a new DriverMatchingEventAvroModel RecordBuilder.
     * @return A new DriverMatchingEventAvroModel RecordBuilder
     */
    public static com.example.kafka.avro.model.DriverMatchingEventAvroModel.Builder newBuilder() {
        return new com.example.kafka.avro.model.DriverMatchingEventAvroModel.Builder();
    }

    /**
     * Creates a new DriverMatchingEventAvroModel RecordBuilder by copying an existing Builder.
     * @param other The existing builder to copy.
     * @return A new DriverMatchingEventAvroModel RecordBuilder
     */
    public static com.example.kafka.avro.model.DriverMatchingEventAvroModel.Builder newBuilder(com.example.kafka.avro.model.DriverMatchingEventAvroModel.Builder other) {
        if (other == null) {
            return new com.example.kafka.avro.model.DriverMatchingEventAvroModel.Builder();
        } else {
            return new com.example.kafka.avro.model.DriverMatchingEventAvroModel.Builder(other);
        }
    }

    /**
     * Creates a new DriverMatchingEventAvroModel RecordBuilder by copying an existing DriverMatchingEventAvroModel instance.
     * @param other The existing instance to copy.
     * @return A new DriverMatchingEventAvroModel RecordBuilder
     */
    public static com.example.kafka.avro.model.DriverMatchingEventAvroModel.Builder newBuilder(com.example.kafka.avro.model.DriverMatchingEventAvroModel other) {
        if (other == null) {
            return new com.example.kafka.avro.model.DriverMatchingEventAvroModel.Builder();
        } else {
            return new com.example.kafka.avro.model.DriverMatchingEventAvroModel.Builder(other);
    ...
    /**
     * RecordBuilder for DriverMatchingEventAvroModel instances.
     */
    @org.apache.avro.specific.AvroGenerated
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DriverMatchingEventAvroModel>
        implements org.apache.avro.data.RecordBuilder<DriverMatchingEventAvroModel> {
         ...
         * @param other The existing Builder to copy.
         */
        private Builder(com.example.kafka.avro.model.DriverMatchingEventAvroModel.Builder other) {
            super(other);
        ...
        /**
         * Creates a Builder by copying an existing DriverMatchingEventAvroModel instance
         * @param other The existing instance to copy.
         */
        private Builder(com.example.kafka.avro.model.DriverMatchingEventAvroModel other) {
            super(SCHEMA$, MODEL$);
            if (isValidValue(fields()[0], other.userId)) {
                this.userId = data().deepCopy(fields()[0].schema(), other.userId);
         ...
         * @return This builder.
         */
        public com.example.kafka.avro.model.DriverMatchingEventAvroModel.Builder setUserId(java.util.UUID value) {
         ...
         * @return This builder.
         */
        public com.example.kafka.avro.model.DriverMatchingEventAvroModel.Builder clearUserId() {
            userId = null;
         ...
         * @return This builder.
         */
        public com.example.kafka.avro.model.DriverMatchingEventAvroModel.Builder setNotificationType(com.example.kafka.avro.model.NotificationType value) {
         ...
         * @return This builder.
         */
        public com.example.kafka.avro.model.DriverMatchingEventAvroModel.Builder clearNotificationType() {
         ...
         * @return This builder.
         */
        public com.example.kafka.avro.model.DriverMatchingEventAvroModel.Builder setMessage(java.lang.CharSequence value) {
         ...
         * @return This builder.
         */
        public com.example.kafka.avro.model.DriverMatchingEventAvroModel.Builder clearMessage() {
            message = null;
         ...
         * @return This builder.
         */
        public com.example.kafka.avro.model.DriverMatchingEventAvroModel.Builder setOrderDetails(com.example.kafka.avro.model.OrderDetails value) {
        ...
        public com.example.kafka.avro.model.DriverMatchingEventAvroModel.Builder setOrderDetailsBuilder(com.example.kafka.avro.model.OrderDetails.Builder value) {
            clearOrderDetails();
         ...
         * @return This builder.
         */
        public com.example.kafka.avro.model.DriverMatchingEventAvroModel.Builder clearOrderDetails() {
            orderDetails = null;
         ...
         * @return This builder.
         */
        public com.example.kafka.avro.model.DriverMatchingEventAvroModel.Builder setDriverDetails(com.example.kafka.avro.model.DriverDetails value) {
        ...
        public com.example.kafka.avro.model.DriverMatchingEventAvroModel.Builder setDriverDetailsBuilder(com.example.kafka.avro.model.DriverDetails.Builder value) {
            clearDriverDetails();
         ...
         * @return This builder.
         */
        public com.example.kafka.avro.model.DriverMatchingEventAvroModel.Builder clearDriverDetails() {
            driverDetails = null;
        ...
        public DriverMatchingEventAvroModel build() {
            try {
                DriverMatchingEventAvroModel record = new DriverMatchingEventAvroModel();
    ...
    @SuppressWarnings("unchecked")
    private static final org.apache.avro.io.DatumWriter<DriverMatchingEventAvroModel>
        WRITER$ = (org.apache.avro.io.DatumWriter<DriverMatchingEventAvroModel>) MODEL$.createDatumWriter(SCHEMA$);
    ...
    @SuppressWarnings("unchecked")
    private static final org.apache.avro.io.DatumReader<DriverMatchingEventAvroModel>
        READER$ = (org.apache.avro.io.DatumReader<DriverMatchingEventAvroModel>) MODEL$.createDatumReader(SCHEMA$);
