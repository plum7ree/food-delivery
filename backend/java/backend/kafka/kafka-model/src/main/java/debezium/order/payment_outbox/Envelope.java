...
public class Envelope extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Envelope(debezium.order.payment_outbox.Value before, debezium.order.payment_outbox.Value after, io.debezium.connector.postgresql.Source source, java.lang.CharSequence op, java.lang.Long ts_ms, event.block transaction) {
    this.before = before;
    this.after = after;
    this.source = source;
    this.op = op;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
      case 0:
        before = (debezium.order.payment_outbox.Value) value$;
        break;
      case 1:
        after = (debezium.order.payment_outbox.Value) value$;
        break;
      case 2:
        source = (io.debezium.connector.postgresql.Source) value$;
        break;
      case 3:
        op = (java.lang.CharSequence) value$;
        break;
      case 4:
        ts_ms = (java.lang.Long) value$;
        break;
      case 5:
        transaction = (event.block) value$;
        break;
      default:
        throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Envelope>
     ...
     * @return This builder.
     */
    public debezium.order.payment_outbox.Envelope.Builder setOp(java.lang.CharSequence value) {
