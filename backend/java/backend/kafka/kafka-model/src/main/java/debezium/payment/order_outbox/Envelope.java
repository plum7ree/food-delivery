...
public class Envelope extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
     ...
     */
    public Envelope(debezium.payment.order_outbox.Value before, debezium.payment.order_outbox.Value after, io.debezium.connector.postgresql.Source source, java.lang.CharSequence op, java.lang.Long ts_ms, event.block transaction) {
        this.before = before;
        this.after = after;
        this.source = source;
        this.op = op;
    ...
    public void put(int field$, java.lang.Object value$) {
        switch (field$) {
            case 0:
                before = (debezium.payment.order_outbox.Value) value$;
                break;
            case 1:
                after = (debezium.payment.order_outbox.Value) value$;
                break;
            case 2:
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Envelope>
         ...
         * @return This builder.
         */
        public debezium.payment.order_outbox.Envelope.Builder setOp(java.lang.CharSequence value) {
