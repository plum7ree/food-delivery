...
VALUES ('db38a0d6-af39-487f-80e0-e88995c8b5bd', '13f0c8f0-eec0-4169-ad9f-e8bb408a5325', 'Burger Place 1', 'BURGER', '10:00:00', '22:00:00', 'url1', 'url2');

-- menus
INSERT INTO user_schema.menus (id, name, description, picture_url, price, currency, restaurant_id, created_at, updated_at)
VALUES ('a59ce8e1-9969-4625-a15c-53d5cf671017', 'Classic Burger', 'Delicious classic burger', 'burger_url1', 10000, 'KRW', 'db38a0d6-af39-487f-80e0-e88995c8b5bd', now(), now()),
       ('5d45696d-232f-40eb-a14f-0c16cff1511a', 'Cheeseburger', 'Tasty cheeseburger with melted cheese', 'burger_url2', 12000, 'KRW', 'db38a0d6-af39-487f-80e0-e88995c8b5bd', now(), now());

-- option_groups
INSERT INTO user_schema.option_groups (id, is_duplicated_allowed, is_necessary, menu_id)
VALUES ('6dbe903a-ae92-4877-b3c5-48f796ee7acb', true, true, 'a59ce8e1-9969-4625-a15c-53d5cf671017'),
       ('6dbe903a-ae92-4877-b3c5-48f796ee7acc', true, false, 'a59ce8e1-9969-4625-a15c-53d5cf671017'),
       ('6dbe903a-ae92-4877-b3c5-48f796ee7acd', true, true, '5d45696d-232f-40eb-a14f-0c16cff1511a'),
       ('6dbe903a-ae92-4877-b3c5-48f796ee7ace', true, false, '5d45696d-232f-40eb-a14f-0c16cff1511a');
...
-- restaurants
INSERT INTO user_schema.restaurants (id, user_id, name, type, open_time, close_time, picture_url1, picture_url2)
VALUES ('13f0c8f0-eec0-4169-ad9f-e8bb408a5325', '10000000-0000-0000-0000-000000000000', 'Pizza Place 1', 'PIZZA', '11:00:00', '23:00:00', 'pizza_url1', 'pizza_url2');

-- menus
INSERT INTO user_schema.menus (id, name, description, picture_url, price, currency, restaurant_id, created_at, updated_at)
VALUES ('d1a99a90-fd1d-4c9c-94a5-75d8a6f95fa5', 'Margherita Pizza', 'Traditional pizza with tomato, mozzarella, and basil', 'pizza1_url1', 15000, 'KRW', '13f0c8f0-eec0-4169-ad9f-e8bb408a5325', now(), now()),
       ('3cc8bc8f-9a1e-4a49-9e5f-40da2cd2a3a1', 'Pepperoni Pizza', 'Classic pizza with pepperoni and cheese', 'pizza1_url2', 17000, 'KRW', '13f0c8f0-eec0-4169-ad9f-e8bb408a5325', now(), now());

-- option_groups
INSERT INTO user_schema.option_groups (id, is_duplicated_allowed, is_necessary, menu_id)
VALUES ('e4db2ad7-0e6f-419d-80de-47e0b89056f3', true, true, 'd1a99a90-fd1d-4c9c-94a5-75d8a6f95fa5'),
       ('f049a923-6767-469a-9e77-9f15b7884c32', true, false, 'd1a99a90-fd1d-4c9c-94a5-75d8a6f95fa5'),
       ('cc94d70a-31d1-4b33-9d3d-04de92680144', true, true, '3cc8bc8f-9a1e-4a49-9e5f-40da2cd2a3a1'),
       ('a0d7e0ed-1684-4a5c-a073-6050a20de8d8', true, false, '3cc8bc8f-9a1e-4a49-9e5f-40da2cd2a3a1');
