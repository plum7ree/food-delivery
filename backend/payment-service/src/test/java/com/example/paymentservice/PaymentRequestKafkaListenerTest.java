...
class PaymentRequestKafkaListenerTest {
    ...
    void shouldProcessPaymentRequestAndSendResponse() {
        ...
        // When
        paymentRequestKafkaListener.receive(Collections.singletonList(paymentRequestAvroModel), Collections.singletonList("key"), Collections.singletonList(0), Collections.singletonList(0L));
